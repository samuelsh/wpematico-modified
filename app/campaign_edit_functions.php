...
class WPeMatico_Campaign_edit_functions {
			...
			<div id="feeds_edit" class="maxhe290">      
			  ...
			  <?php $id=0;
				...
				<div class="<?php if(($id % 2) == 0) echo 'bw'; else echo 'lightblue'; ?>">
					...
					<?php do_action('nonstatic_feedat',$feed, $cfg);  ?>
			  ...
			  <?php endforeach ?>
				...
				<div class="pDiv jobtype-select">
					...
					<?php do_action('nonstatic_feedat','', $cfg);  ?>
	...
	public static function post_submitbox_start()	{
		...
		<div class="postbox inside" style="min-width:30%;float:left;padding: 5px;">
			<b><?php _e('Status',  WPeMatico :: TEXTDOMAIN ); ?></b><br />
		...
		<b><?php _e('Post type',  WPeMatico :: TEXTDOMAIN ); ?></b><br />
		<?php
			$args=array(
			  'public'   => true
			); 
